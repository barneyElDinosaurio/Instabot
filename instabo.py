...
reseteo = firebase.get('/user'+ usuario, 'reseteo')
       
nombre = firebase.get('/user'+ usuario, 'nombre')
passes = firebase.get('/user'+ usuario, 'password')
hashs = firebase.get('/user'+ usuario, 'Hashs')
locs = firebase.get('/user'+ usuario, 'Locs')
comment = firebase.get('/user'+ usuario, 'Comment')
